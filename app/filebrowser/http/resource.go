...
func resourceDeleteHandler(fileCache FileCache) handleFunc {
	return withEditor(func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
...
var resourcePutHandler = withEditor(func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
