...
func withUser(fn handleFunc) handleFunc {
	return func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
		...
		req, err := http.NewRequest("POST", "http://127.0.0.1:8000/fb_auth", nil)
		if err != nil {
...
func withEditor(fn handleFunc) handleFunc {
	return withUser(func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
		...
		req, err := http.NewRequest("POST", "http://127.0.0.1:8000/fb_edit", nil)
		if err != nil {
...
func withAdmin(fn handleFunc) handleFunc {
	return withUser(func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
		...
		req, err := http.NewRequest("POST", "http://127.0.0.1:8000/fb_admin", nil)
		if err != nil {
			return http.StatusForbidden, nil
		}
